            ...
            {state.succeeded ? (
              ...
              <form onSubmit={handleSubmit} noValidate style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                ...
                <div className="cf-field">
                  <label className="cf-label">{t("Nome Completo", "Full Name")}</label>
                  <div className="cf-input-wrap">
                    <input id="name" name="name" type="text" required placeholder="Mario Rossi" className="cf-input" />
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                  <div className="cf-field">
                    ...
                    <div className="cf-input-wrap">
                      <input id="email" name="email" type="email" required placeholder="mario@email.it" className="cf-input" />
                      <span className="cf-icon">
                  ...
                  <div className="cf-field">
                    <label className="cf-label">{t("Telefono", "Phone")}</label>
                    <div className="cf-input-wrap">
                      <input id="phone" name="phone" type="tel" placeholder="+39 000 000 0000" className="cf-input" />
                      <span className="cf-icon">
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
                          <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 10.8 19.79 19.79 0 01.22 2.18 2 2 0 012.18 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 7.91a16 16 0 006.29 6.29l1.28-1.28a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/>
                        </svg>
                ...
                <div className="cf-field">
                  <label className="cf-label">{t("Descrivi il Progetto", "Describe Your Project")}</label>
